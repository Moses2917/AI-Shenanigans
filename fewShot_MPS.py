...
class ContrastiveLoss(nn.Module):
    ...
    def forward(self, similarity, positive_idx):
        positive_idx = positive_idx.squeeze(-1)  # Fix dimensionality
...
def train_model(json_path, image_dir, output_dir, num_epochs=10, batch_size=28, 
                learning_rate=1e-4, device='mps'):
    model = create_symbol_matcher(image_size=800, patch_size=32, in_channels=1,
                                embed_dim=512, depth=6, num_heads=8).to(device)
...
def run_inference(model_path, reference_image, candidate_images, device='mps'):
    # Load model
...
if __name__ == "__main__":
    ...
    image_dir = "./train"
    output_dir = "./"
    model = train_model(json_path,image_dir,output_dir)
    ...
    candidate_images = [
        Image.open(r"\train\PC-set-E-shts-7-20-22-21-11-2-1_png.rf.45da7a961b4480a5e9259aac071a952b.jpg").convert('RGB'),
    ...
    img:Image = Image.open(r"\train\PC-set-E-shts-7-20-22-21-11-2-1_png.rf.45da7a961b4480a5e9259aac071a952b.jpg").convert('RGB'),
